...
# AA: Temporarily over-ride the above to set the following custom prompt. 
PS1="[\u@\h]\d \t\n\w\n$ " #AA
...
#To ensure ipython is running from inside a virtualenv
...
export PATH=$HOME/anaconda/bin:$PATH #added by anaconda
export PATH=$PATH:/home/aman/domino #added by domino
export PATH=$PATH:/usr/local/domino #added by domino
